...
function ProfileComponent() {
  ...
  return (
    <main className="flex-1 bg-[#f5f7fc] px-6 pb-32 pt-24">
      ...
      <section className="mx-auto mt-7 rounded-[1.75rem] bg-white p-5 shadow-[0_4px_14px_rgba(15,23,42,0.10)] ring-1 ring-slate-200/80">
      ...
      <section className="mt-7">
        ...
        {activeTab === "activity" && (
          <div className="mt-4 overflow-hidden rounded-[1.4rem] bg-white shadow-[0_3px_12px_rgba(15,23,42,0.08)] ring-1 ring-slate-200/80">
            <table className="w-full text-left">
              ...
              <tbody>
                {activities.map((activity, index) => (
                  <tr key={activity.title} className={index % 2 === 0 ? "bg-white" : "bg-slate-50/60"}>
                    <td className="px-4 py-3 text-sm font-bold text-[#061835]">{activity.title}</td>
                    <td className="px-4 py-3 text-xs font-medium text-[#53657f]">
                      <span className="flex items-center gap-1">
                        <Clock3 size={13} className="text-[#94a3b8]" />
                        {activity.time}
                      </span>
                    </td>
